...
| Session Manager plugin | latest | `aws ecs execute-command` in [3.6.4](../3.6-Compute/3.6.4-database-init/) and [3.8.4](../3.8-Observability/3.8.4-debugging/) |
...
Section [3.7](../3.7-Delivery/) explains the whole arrangement.
{{% /notice %}}
