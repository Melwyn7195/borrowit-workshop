...
| Session Manager plugin | mới nhất | `aws ecs execute-command` ở [3.6.4](../3.6-Compute/3.6.4-database-init/) và [3.8.4](../3.8-Observability/3.8.4-debugging/) |
...
[3.7](../3.7-Delivery/) giải thích toàn bộ cách sắp xếp này.
{{% /notice %}}
