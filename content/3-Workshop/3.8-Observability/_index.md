...
|---|---|---|
| What did the application do? | CloudWatch Logs | [3.8.1](3.8.1-logs/) |
| How is the system behaving over time? | CloudWatch Metrics + dashboard | [3.8.2](3.8.2-metrics-dashboard/) |
| Should someone be woken up? | CloudWatch Alarms + SNS | [3.8.3](3.8.3-alarms/) |
| What is actually happening inside right now? | ECS Exec | [3.8.4](3.8.4-debugging/) |
...
`cdk destroy BorrowitApp` working ([3.1](../3.1-Overview/)).
...
1. [Logs](3.8.1-logs/)
2. [Metrics and the dashboard](3.8.2-metrics-dashboard/)
3. [Alarms and notification](3.8.3-alarms/)
4. [Debugging a running task](3.8.4-debugging/)
