...
| `exec format error` | Image built for the wrong CPU architecture ([3.6.1](../../3.6-Compute/3.6.1-image-and-registry/)) |
| Exit code **137** | Killed — out of memory ([3.8.2](../3.8.2-metrics-dashboard/)) |
...
Because liveness and readiness differ ([3.6.3](../../3.6-Compute/3.6.3-load-balancer/)),
