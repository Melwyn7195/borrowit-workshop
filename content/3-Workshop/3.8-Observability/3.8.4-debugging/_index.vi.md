...
| `exec format error` | Image build sai kiến trúc CPU ([3.6.1](../../3.6-Compute/3.6.1-image-and-registry/)) |
| Mã thoát **137** | Bị giết — hết bộ nhớ ([3.8.2](../3.8.2-metrics-dashboard/)) |
...
([3.6.3](../../3.6-Compute/3.6.3-load-balancer/)), triệu chứng của chúng cũng khác
