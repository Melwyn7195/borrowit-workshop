...
1. [Compute — vì sao chọn Fargate thay vì Lambda](3.3.1-compute/)
2. [Cơ sở dữ liệu — vì sao chọn RDS thay vì Aurora Serverless hay DynamoDB](3.3.2-database/)
3. [Mạng — vì sao không dùng NAT Gateway](3.3.3-networking/)
4. [Phân phối, lưu trữ và secret](3.3.4-delivery-and-secrets/)
