...
1. [Compute — why Fargate rather than Lambda](3.3.1-compute/)
2. [Database — why RDS rather than Aurora Serverless or DynamoDB](3.3.2-database/)
3. [Networking — why no NAT Gateway](3.3.3-networking/)
4. [Delivery, storage and secrets](3.3.4-delivery-and-secrets/)
