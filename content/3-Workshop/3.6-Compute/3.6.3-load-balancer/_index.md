...
| Metrics | Request counts, latency percentiles, 4xx/5xx — the basis of [3.8](../../3.8-Observability/) |
...
[3.4](../../3.4-Network/) and making the source of truth ambiguous.
...
The security group design in [3.3.3](../../3.3-Architecture/3.3.3-networking/)
