...
| Metric | Số request, phân vị độ trễ, 4xx/5xx — nền tảng cho [3.8](../../3.8-Observability/) |
...
rule vào security group, trùng lặp với rule đã định nghĩa ở [3.4](../../3.4-Network/)
...
Thiết kế security group ở [3.3.3](../../3.3-Architecture/3.3.3-networking/)
