...
nơi chỉ lưu ARN. Xem [3.3.4](../../3.3-Architecture/3.3.4-delivery-and-secrets/)
...
| Thiết lập | Tác dụng |
|---|---|
| `assignPublicIp` + subnet `PUBLIC` | Truy cập chiều ra mà không cần NAT — [3.3.3](../../3.3-Architecture/3.3.3-networking/) |
...
| `enableExecuteCommand` | Mở shell trong task đang chạy — [3.6.4](../3.6.4-database-init/), [3.8.4](../../3.8-Observability/3.8.4-debugging/) |
...
[3.8.3](../../3.8-Observability/3.8.3-alarms/) — truyền ngay bây giờ thì đỡ được
