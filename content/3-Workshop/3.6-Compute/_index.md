...
~$36, but it is permanent; see [3.4](../3.4-Network/).)

The reasoning for choosing Fargate is in
[3.3.1](../3.3-Architecture/3.3.1-compute/); this section builds it.
...
| Dashboard + 7 alarms + SNS topic | Covered in [3.8](../3.8-Observability/) | ~$4.80 |

#### Content

1. [Container image and registry](3.6.1-image-and-registry/)
2. [Task definition and service](3.6.2-task-and-service/)
3. [Load balancer and health checks](3.6.3-load-balancer/)
4. [Initialising the database](3.6.4-database-init/)
