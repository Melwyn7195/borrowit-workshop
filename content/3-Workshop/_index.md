...
1. [Introduction](3.1-Overview/)
2. [Choosing the AWS services](3.3-Architecture/)
3. [Prerequisites](3.2-Prerequisites/)
4. [Network foundation](3.4-Network/)
5. [Data layer](3.5-Data/)
6. [Compute layer](3.6-Compute/)
7. [Content delivery](3.7-Delivery/)
8. [Observability and operations](3.8-Observability/)
9. [Clean up](3.11-Cleanup/)
