...
[4.3.3](../4.3-Architecture/4.3.3-networking/); this page builds it.
...
[4.3.3](../4.3-Architecture/4.3.3-networking/). This one adds a route to the
...
![VPC resource map: four subnets across two AZs, one internet gateway, no NAT Gateway](/images/4-Workshop/4.4-Network/vpc-resource-map.png?width=100pc)

![The three security groups with inbound rules expanded, each referencing the previous group rather than a CIDR](/images/4-Workshop/4.4-Network/security-groups.png?width=100pc)
