...
[3.4](../4.4-Network/) và [3.5](../4.5-Data/). Khôi phục bằng:
...
[3.6.1](../4.6-Compute/4.6.1-image-and-registry/) và đã push `v1` chứ không phải
...
Khôi phục stack đúng là trường hợp mà [3.7](../4.7-Delivery/) đã cảnh báo.
{{% /notice %}}
...
[3.6.4](../4.6-Compute/4.6.4-database-init/).
{{% /notice %}}
...
import. Đây là quan hệ phụ thuộc một chiều ở [3.1](../4.1-Overview/) xuất hiện
lần cuối.
...
|---|---|---|
| **ALB gọi trực tiếp được qua HTTP** | Ai biết hostname đều có thể bỏ qua edge và gọi API không mã hoá | Giới hạn security group của ALB theo prefix list `origin-facing` của CloudFront ($0), hoặc tên miền + chứng chỉ ACM ([3.7](../4.7-Delivery/)) |
