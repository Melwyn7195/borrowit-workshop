...
do: các metric filter ở [3.8.3](../4.8.3-alarms/) và các saved query bên dưới cần
...
![Truy vấn CloudWatch Logs Insights kèm kết quả](/images/4-Workshop/4.8-Observability/4.8.1-logs/insights-query.png?width=100pc)
