...
![Toàn bộ dashboard CloudWatch với dữ liệu traffic thật](/images/4-Workshop/4.8-Observability/4.8.2-metrics-dashboard/dashboard.png?width=100pc)
...
nhớ ở [3.8.3](../4.8.3-alarms/) đặt tại 85% thay vì 80% như CPU.
