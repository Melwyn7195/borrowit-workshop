...
|---|---|---|
| Ứng dụng đã làm gì? | CloudWatch Logs | [3.8.1](4.8.1-logs/) |
| Hệ thống vận hành ra sao theo thời gian? | CloudWatch Metrics + dashboard | [3.8.2](4.8.2-metrics-dashboard/) |
| Có cần đánh thức ai không? | CloudWatch Alarms + SNS | [3.8.3](4.8.3-alarms/) |
| Ngay lúc này bên trong đang xảy ra chuyện gì? | ECS Exec | [3.8.4](4.8.4-debugging/) |
...
1. [Log](4.8.1-logs/)
2. [Metric và dashboard](4.8.2-metrics-dashboard/)
3. [Alarm và thông báo](4.8.3-alarms/)
4. [Gỡ lỗi task đang chạy](4.8.4-debugging/)
