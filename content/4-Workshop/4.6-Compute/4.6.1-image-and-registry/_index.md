...
![ECR repository listing the pushed image with its tag, size and pushed-at time](/images/4-Workshop/4.6-Compute/4.6.1-image-and-registry/ecr-image.png?width=100pc)
