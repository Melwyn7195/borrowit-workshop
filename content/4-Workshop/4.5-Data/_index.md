...
[4.3.2](../4.3-Architecture/4.3.2-database/).
...
container in [3.6.4](../4.6-Compute/4.6.4-database-init/), rather than from a
workstation.
...
![RDS instance: status Available, class db.t4g.micro, Multi-AZ No](/images/4-Workshop/4.5-Data/rds-instance.png?width=100pc)

![Connectivity & security tab: Publicly accessible No, DatabaseSecurityGroup attached, subnet group listing the isolated subnets](/images/4-Workshop/4.5-Data/rds-connectivity.png?width=100pc)
