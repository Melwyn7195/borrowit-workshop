...
[3.6.4](../4.6-Compute/4.6.4-database-init/) thay vì từ máy trạm.
...
![Instance RDS: trạng thái Available, class db.t4g.micro, Multi-AZ No](/images/4-Workshop/4.5-Data/rds-instance.png?width=100pc)

![Tab Connectivity & security: Publicly accessible No, DatabaseSecurityGroup đã gắn, subnet group liệt kê các isolated subnet](/images/4-Workshop/4.5-Data/rds-connectivity.png?width=100pc)
