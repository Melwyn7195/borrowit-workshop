...
|---|---|
| [3.2 Chuẩn bị](../4.2-Prerequisites/) | Cần có sẵn những gì trước khi deploy |
| [3.3 Mô tả kiến trúc](../4.3-Architecture/) | Hệ thống trông ra sao, và vì sao chọn các dịch vụ này |
| 3.4 – 3.8 | Dựng từng tầng thế nào, theo đúng thứ tự deploy |
| [3.11 Dọn dẹp](../4.11-Cleanup/) | Xoá gì, theo thứ tự nào, và giữ lại những gì |
...
+ Tên miền riêng và TLS **trên load balancer**. Trình duyệt luôn nói HTTPS với
  ...
  — xem [3.7](../4.7-Delivery/) để biết cái giá của điều đó và cách khắc phục.
